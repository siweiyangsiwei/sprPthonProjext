...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.treeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "实验一  氨基甲酸铵分解反应平衡常数的测定"))
        self.treeWidget.topLevelItem(0).setText(1, _translate("MainWindow", "-"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("MainWindow", "实验二  电解质溶液电导的测定"))
        self.treeWidget.topLevelItem(1).setText(1, _translate("MainWindow", "-"))
        self.treeWidget.topLevelItem(2).setText(0, _translate("MainWindow", "实验三  碘和碘离子反应平衡常数的测定"))
