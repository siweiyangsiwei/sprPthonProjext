...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(200, 10, 1381, 1121))
        ...
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.test)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(49, 519, 1301, 461))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.section_A = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        ...
        self.verticalLayout.addWidget(self.section_A)
        self.section_B = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.section_B.setFont(font)
        self.section_B.setObjectName("section_B")
        self.verticalLayout.addWidget(self.section_B)
        self.section_C = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.section_C.setFont(font)
        self.section_C.setObjectName("section_C")
        self.verticalLayout.addWidget(self.section_C)
        self.section_D = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        font.setPointSize(20)
        self.section_D.setFont(font)
        self.section_D.setObjectName("section_D")
        self.verticalLayout.addWidget(self.section_D)
